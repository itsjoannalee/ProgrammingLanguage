...
public class Tester {
	public static void main(String[] args) {
		...
		System.out.println("c1 left "+c1.getMoney()+" USDdollars");
		System.out.println("C2 pays "+c2.pay()+" USD dollars");//c2要多付25 再被扣50
		System.out.println("c2 left "+c2.getMoney()+" USDdollars");
		System.out.println("d1 got salary "+d1.salary()+" USDdollar");
	}
